...
# Use Cases
API for frontend Web App, Mobile App. Workflow modelling, Order Orchestration etc
...
Serverless Framework to deploy the complete stack on fly and remove on fly
